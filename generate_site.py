...
<article style="background:var(--ink);border-radius:var(--radius);padding:22px;
  ...
  <div style="display:flex;gap:5px;margin-bottom:11px">
    ...
    <span class="badge" style="background:rgba(255,255,255,.08);color:rgba(244,237,224,.6)">{e(cat_label(a.get("category_main","")))}</span>
  </div>
  ...
  <p style="font-size:12px;color:rgba(244,237,224,.5);line-height:1.7;margin-bottom:14px">
    {e(a.get("lead_ja",""))}</p>
  <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:8px">
    ...
    <div style="display:flex;align-items:center;gap:6px">
      ...
      <span style="font-size:10px;color:rgba(244,237,224,.35)">{e(sname)}</span>
      {src_link}
    </div>
  </div>
</article>
